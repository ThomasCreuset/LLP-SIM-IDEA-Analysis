...
SourceDirectory: /eos/user/s/svashish/FCCAnalyses_pre
BuildDirectory: /eos/user/s/svashish/FCCAnalyses_pre

# Where to place the cost data store
CostDataFile: 

# Site is something like machine.domain, i.e. pragmatic.crd
Site: lxplus949.cern.ch
...
ConfigureCommand: "/cvmfs/sw.hsf.org/key4hep/releases/2024-03-10/x86_64-almalinux9-gcc11.3.1-opt/cmake/3.27.9-4qfmfr/bin/cmake" "/eos/user/s/svashish/FCCAnalyses_pre"
