...
class Analysis():
    ...
    def __init__(self, cmdline_args):
        ...
        parser.add_argument("--sample", dest="sample", help="Sample to analyze", type=str,default=None)
        ...
        if self.ana_args.sample is not None:
            self.process_list = {self.ana_args.sample: {'fraction': 1.0}} 
        ...
        self.input_dir = '/data/dust/user/creusett/SummerSchool/Data/k4SD'
        self.output_dir = '/data/dust/user/creusett/SummerSchool/Data/FCCAna/Stage1'
