...
cutList = {
    ...
    "Beta_Cut": (
        "n_RecoTracks > -1"
        " && Any(Beta_RecoedPrimaryTracks < 0.8)"
    ),
}
...
histoList = {
    ...
    "RecoedPrimaryTracks_theta": {"name":"RecoedPrimaryTracks_theta", "title":"Recoed primary tracks #theta", "bin":30, "xmin":0, "xmax":3.2},
    ...
    "PV2V0Cos": {"name":"PV2V0Cos", "title":"Cosine angle between displaced vertex and primary vertex", "bin":20, "xmin":0, "xmax":1},
    "RecoedPrimaryTrack_mass": {"name":"RecoedPrimaryTrack_mass", "title":"Mass of escaping tracks [GeV]", "bin":50, "xmin":0, "xmax":200},
    ...
    "EscapingTracks_mass": {"name":"EscapingTracks_mass", "title":"Mass of escaping tracks [GeV]", "bin":50, "xmin":0, "xmax":200},
